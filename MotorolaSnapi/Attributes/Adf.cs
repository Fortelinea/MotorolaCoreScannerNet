...
namespace Motorola.Snapi.Attributes
{
    ...
    ///     <remarks>
    ///         The ADF buffer attribute contains a proprietary format which stores data formatting configurations. This format
    ///         is not published however, the contents of this attribute can be copied from a "golden" scanner which
    ///         has the correct settings and copied to other devices.
    ///     </remarks>
    /// </summary>
    public class Adf : MotorolaAttributeSet
    {
        ...
        ///     <remarks>
        ///         The ADF rules are in a proprietary format. End users wishing to deploy ADF rules should first manually program
        ///         the scanner using programming bar codes and then reading the attribute from an application. The rule can then
        ///         be
        ...
        {
            get { return (byte[])GetAttribute((ushort)AdfAttribute.ADFRules).Value; }
            set
            {
                SetAttribute(new ScannerAttribute
                             {
                                 Id = (ushort)AdfAttribute.ADFRules,
        ...
        public byte KeyCategory1
        {
            ...
            set
            {
                SetAttribute(new ScannerAttribute
                             {
                                 Id = (ushort)AdfAttribute.KeyCategory1,
        ...
        public byte KeyCategory2
        {
            ...
            set
            {
                SetAttribute(new ScannerAttribute
                             {
                                 Id = (ushort)AdfAttribute.KeyCategory2,
                                 DataType = DataType.Byte,
                                 Value = value
                             });
            }
        ...
        public byte KeyCategory3
        {
            ...
            set
            {
                SetAttribute(new ScannerAttribute
                             {
                                 Id = (ushort)AdfAttribute.KeyCategory3,
                                 DataType = DataType.Byte,
                                 Value = value
                             });
            }
        ...
        public byte KeyCategory4
        {
            ...
            set
            {
                SetAttribute(new ScannerAttribute
                             {
                                 Id = (ushort)AdfAttribute.KeyCategory4,
                                 DataType = DataType.Byte,
                                 Value = value
                             });
            }
        ...
        public byte KeyCategory5
        {
            ...
            set
            {
                SetAttribute(new ScannerAttribute
                             {
                                 Id = (ushort)AdfAttribute.KeyCategory5,
                                 DataType = DataType.Byte,
                                 Value = value
                             });
            }
        ...
        public byte KeyCategory6
        {
            ...
            set
            {
                SetAttribute(new ScannerAttribute
                             {
                                 Id = (ushort)AdfAttribute.KeyCategory6,
                                 DataType = DataType.Byte,
                                 Value = value
                             });
            }
        ...
        public byte KeyDelay
        {
            ...
            set
            {
                SetAttribute(new ScannerAttribute
                             {
                                 Id = (ushort)AdfAttribute.KeyDelay,
                                 DataType = DataType.Byte,
                                 Value = value
                             });
            }
        ...
        public byte KeyValue1
        {
            ...
            set
            {
                SetAttribute(new ScannerAttribute
                             {
                                 Id = (ushort)AdfAttribute.KeyValue1,
                                 DataType = DataType.Byte,
                                 Value = value
                             });
            }
        ...
        public byte KeyValue2
        {
            ...
            set
            {
                SetAttribute(new ScannerAttribute
                             {
                                 Id = (ushort)AdfAttribute.KeyValue2,
                                 DataType = DataType.Byte,
                                 Value = value
                             });
            }
        ...
        public byte KeyValue3
        {
            ...
            set
            {
                SetAttribute(new ScannerAttribute
                             {
                                 Id = (ushort)AdfAttribute.KeyValue3,
                                 DataType = DataType.Byte,
                                 Value = value
                             });
            }
        ...
        public byte KeyValue4
        {
            ...
            set
            {
                SetAttribute(new ScannerAttribute
                             {
                                 Id = (ushort)AdfAttribute.KeyValue4,
                                 DataType = DataType.Byte,
                                 Value = value
                             });
            }
        ...
        public byte KeyValue5
        {
            ...
            set
            {
                SetAttribute(new ScannerAttribute
                             {
                                 Id = (ushort)AdfAttribute.KeyValue5,
                                 DataType = DataType.Byte,
                                 Value = value
                             });
            }
        ...
        public byte KeyValue6
        {
            ...
            set
            {
                SetAttribute(new ScannerAttribute
                             {
                                 Id = (ushort)AdfAttribute.KeyValue6,
                                 DataType = DataType.Byte,
                                 Value = value
                             });
            }
        ...
        public byte PauseDuration
        {
            ...
            set
            {
                SetAttribute(new ScannerAttribute
                             {
                                 Id = (ushort)AdfAttribute.PauseDuration,
                                 DataType = DataType.Byte,
                                 Value = value
                             });
            }
        ...
        ///     <para>
        ///         The parameter controls the simple data
        ///         formatting where data is presented in
        ///         <code>&lt;prefix1&gt;&lt;data&gt;&lt;suffix1&gt;&lt;suffix2&gt;.</code>
        ///     </para>
        ///     <remarks>
        ///         Values:
        ///         <para>0 – &lt;DATA&gt;</para>
        ...
        ///         <para>7 – &lt;PREFIX&gt;&lt;DATA&gt;&lt;SUFFIX1&gt;&lt;SUFFIX2&gt;</para>
        ///     </remarks>
        /// </summary>
        public byte SimpleDataFormat
        {
            ...
            set
            {
                SetAttribute(new ScannerAttribute
                             {
                                 Id = (ushort)AdfAttribute.SimpleDataFormat,
                                 DataType = DataType.Byte,
                                 Value = value
                             });
            }
