...
namespace Motorola.Snapi.Attributes
{
    ...
    public class Codabar : MotorolaAttributeSet
    {
        ...
        ///     <para>
        ///         This parameter strips the start and stop characters and inserts a space after the first, fifth, and tenth
        ///         characters of a 14-character Codabar
        ///         symbol. Symbol length does not include start and stop characters.
        ///     </para>
        /// </summary>
        public bool ClsiEditingEnabled
        {
            get { return (bool)GetAttribute((ushort)CodabarAttribute.ClsiEditing).Value; }
            set
            {
                SetAttribute(new ScannerAttribute
                             {
                                 Id = (ushort)CodabarAttribute.ClsiEditing,
        ...
        {
            get { return (bool)GetAttribute((ushort)CodabarAttribute.Codabar).Value; }
            set
            {
                SetAttribute(new ScannerAttribute
                             {
                                 Id = (ushort)CodabarAttribute.Codabar,
                                 DataType = DataType.Bool,
                                 Value = value
                             });
            }
        ...
        public ushort LengthForCodabarLength1
        {
            ...
            get { return Convert.ToUInt16(GetAttribute((ushort)CodabarAttribute.LengthForCodabarLength1).Value); }
            set
            {
                SetAttribute(new ScannerAttribute
                             {
                                 Id = (ushort)CodabarAttribute.LengthForCodabarLength1,
        ...
        {
            //Not sure what this actually does or what the values mean.
            get { return Convert.ToUInt16(GetAttribute((ushort)CodabarAttribute.LengthForCodabarLength2).Value); }
            set
            {
                SetAttribute(new ScannerAttribute
                             {
                                 Id = (ushort)CodabarAttribute.LengthForCodabarLength2,
                                 DataType = DataType.Byte,
                                 Value = value
                             });
            }
        ...
        {
            get { return (bool)GetAttribute((ushort)CodabarAttribute.NotisEditing).Value; }
            set
            {
                SetAttribute(new ScannerAttribute
                             {
                                 Id = (ushort)CodabarAttribute.NotisEditing,
                                 DataType = DataType.Bool,
                                 Value = value
                             });
            }
