...
namespace Motorola.Snapi.Attributes
{
    ...
    public class Code128 : MotorolaAttributeSet
    {
        ...
        {
            get { return (bool)GetAttribute((ushort)Code128Attribute.Code128).Value; }
            set
            {
                SetAttribute(new ScannerAttribute
                             {
                                 Id = (ushort)Code128Attribute.Code128,
        ...
        public ushort Code128Length1
        {
            ...
            get { return Convert.ToUInt16(GetAttribute((ushort)Code128Attribute.Code128Length1).Value); }
            set
            {
                SetAttribute(new ScannerAttribute
                             {
                                 Id = (ushort)Code128Attribute.Code128Length1,
        ...
        {
            //Not sure what this actually does or what the values mean.
            get { return Convert.ToUInt16(GetAttribute((ushort)Code128Attribute.Code128Length2).Value); }
            set
            {
                SetAttribute(new ScannerAttribute
                             {
                                 Id = (ushort)Code128Attribute.Code128Length2,
                                 DataType = DataType.Byte,
                                 Value = value
                             });
            }
        ...
        {
            get { return (bool)GetAttribute((ushort)Code128Attribute.Code128Redundancy).Value; }
            set
            {
                SetAttribute(new ScannerAttribute
                             {
                                 Id = (ushort)Code128Attribute.Code128Redundancy,
                                 DataType = DataType.Bool,
                                 Value = value
                             });
            }
        ...
        {
            get { return (bool)GetAttribute((ushort)Code128Attribute.Ean128Emulation).Value; }
            set
            {
                SetAttribute(new ScannerAttribute
                             {
                                 Id = (ushort)Code128Attribute.Ean128Emulation,
                                 DataType = DataType.Bool,
                                 Value = value
                             });
            }
        ...
        {
            get { return (bool)GetAttribute((ushort)Code128Attribute.Isbt128).Value; }
            set
            {
                SetAttribute(new ScannerAttribute
                             {
                                 Id = (ushort)Code128Attribute.Isbt128,
                                 DataType = DataType.Bool,
                                 Value = value
                             });
            }
        ...
        {
            get { return (bool)GetAttribute((ushort)Code128Attribute.UccEan128).Value; }
            set
            {
                SetAttribute(new ScannerAttribute
                             {
                                 Id = (ushort)Code128Attribute.UccEan128,
                                 DataType = DataType.Bool,
                                 Value = value
                             });
            }
