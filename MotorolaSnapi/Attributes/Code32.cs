...
namespace Motorola.Snapi.Attributes
{
    ...
    public class Code32 : MotorolaAttributeSet
    {
        ...
        {
            get { return (bool)GetAttribute((ushort)Code32Attribute.Code32).Value; }
            set
            {
                SetAttribute(new ScannerAttribute
                             {
                                 Id = (ushort)Code32Attribute.Code32,
        ...
        {
            get { return (bool)GetAttribute((ushort)Code32Attribute.Code32Prefix).Value; }
            set
            {
                SetAttribute(new ScannerAttribute
                             {
                                 Id = (ushort)Code32Attribute.Code32Prefix,
                                 DataType = DataType.Bool,
                                 Value = value
                             });
            }
