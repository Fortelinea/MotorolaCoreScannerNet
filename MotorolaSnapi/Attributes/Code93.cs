...
namespace Motorola.Snapi.Attributes
{
    ...
    public class Code93 : MotorolaAttributeSet
    {
        ...
        {
            get { return (bool)GetAttribute((ushort)Code93Attribute.Code93).Value; }
            set
            {
                SetAttribute(new ScannerAttribute
                             {
                                 Id = (ushort)Code93Attribute.Code93,
        ...
        public ushort LengthForCode93Length1
        {
            ...
            get { return Convert.ToUInt16(GetAttribute((ushort)Code93Attribute.LengthForCode93Length1).Value); }
            set
            {
                SetAttribute(new ScannerAttribute
                             {
                                 Id = (ushort)Code93Attribute.LengthForCode93Length1,
        ...
        {
            //Not sure what this actually does or what the values mean.
            get { return Convert.ToUInt16(GetAttribute((ushort)Code93Attribute.LengthForCode93Length2).Value); }
            set
            {
                SetAttribute(new ScannerAttribute
                             {
                                 Id = (ushort)Code93Attribute.LengthForCode93Length2,
                                 DataType = DataType.Byte,
                                 Value = value
                             });
            }
