    ...
    public class Discovery : MotorolaAttributeSet
    {
        ...
        public byte[] BluetoothAddress
        {
            get
            {
                ...
                return attribute != null ? ValueConverters.HexStringToByteArray((string)attribute.Value) : null;
            }
        }
        ...
        ///     <para>
        ///         Reports firmware versions of the multiple CPU’s on
        ///         a single product with space delimiters.
        ///     </para>
        ///     <para>For example: "NBRPUAAA NBRPUDAA"</para>
        /// </summary>
        public string CombinedFirmwareVersion => (string)GetAttribute((ushort)DiscoveryAttribute.CombinedFirmwareVersion).Value;

        /// <summary>
        ///     <para>Driver Attribute Name: ConfigurationFilename</para>
        ///     <para>
        ///         Identifies the device configuration. Scanning
        ...
        public string ConfigurationFilename
        {
            ...
            set
            {
                SetAttribute(new ScannerAttribute
                             {
                                 Id = (ushort)DiscoveryAttribute.ConfigurationFilename,
        ...
        public DateTime DateOfFirstProgramming
        {
            ...
            set
            {
                SetAttribute(new ScannerAttribute
                             {
                                 Id = (ushort)DiscoveryAttribute.DateOfFirstProgramming,
                                 DataType = DataType.String,
                                 Value = value.ToString("DDMMMYY")
                             });
            }
        }
        ...
        ///     <para>For example: "15APR05"</para>
        /// </summary>
        public DateTime DateOfManufacture => DateTime.Parse((string)GetAttribute((ushort)DiscoveryAttribute.DateOfManufacture).Value);
        ...
        ///     </para>
        /// </summary>
        public string DeviceClass => (string)GetAttribute((ushort)DiscoveryAttribute.DeviceClass).Value;
        ...
        /// </summary>
        public string ImagekitVersion => (string)GetAttribute((ushort)DiscoveryAttribute.ImagekitVersion).Value;
        ...
        /// </summary>
        public string ModelNumber => (string)GetAttribute((ushort)DiscoveryAttribute.ModelNumber).Value;
        ...
        /// </summary>
        public string RsmVersion => (string)GetAttribute((ushort)DiscoveryAttribute.RSMVersion).Value;
        ...
        /// </summary>
        public string ScankitVersion => (string)GetAttribute((ushort)DiscoveryAttribute.ScankitVersion).Value;
        ...
        /// </summary>
        public string ScannerFirmwareVersion => (string)GetAttribute((ushort)DiscoveryAttribute.ScannerFirmwareVersion).Value;
        ...
        /// </summary>
        public string SerialNumber => (string)GetAttribute((ushort)DiscoveryAttribute.SerialNumber).Value;
    }
}