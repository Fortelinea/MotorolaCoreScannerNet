...
namespace Motorola.Snapi.Attributes
{
    ...
    public class Discrete2Of5 : MotorolaAttributeSet
    {
        ...
        {
            get { return (bool)GetAttribute((ushort)Discrete2Of5Attribute.Discrete2Of5).Value; }
            set
            {
                SetAttribute(new ScannerAttribute
                             {
                                 Id = (ushort)Discrete2Of5Attribute.Discrete2Of5,
        ...
        public ushort LengthForD2Of5Length1
        {
            ...
            get { return Convert.ToUInt16(GetAttribute((ushort)Discrete2Of5Attribute.LengthForD2Of5Length1).Value); }
            set
            {
                SetAttribute(new ScannerAttribute
                             {
                                 Id = (ushort)Discrete2Of5Attribute.LengthForD2Of5Length1,
        ...
        {
            //Not sure what this actually does or what the values mean.
            get { return Convert.ToUInt16(GetAttribute((ushort)Discrete2Of5Attribute.LengthForD2Of5Length2).Value); }
            set
            {
                SetAttribute(new ScannerAttribute
                             {
                                 Id = (ushort)Discrete2Of5Attribute.LengthForD2Of5Length2,
                                 DataType = DataType.Byte,
                                 Value = value
                             });
            }
