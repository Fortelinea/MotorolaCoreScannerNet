...
namespace Motorola.Snapi.Attributes
{
    ...
    public class Imaging : MotorolaAttributeSet
    {
        ...
        {
            get { return Convert.ToUInt16(GetAttribute((ushort)ImagingAttribute.AimBrightness).Value); }
            set
            {
                SetAttribute(new ScannerAttribute
                             {
                                 Id = (ushort)ImagingAttribute.AimBrightness,
        ...
        ///     <para>
        ///         Set to true to stay in Snapshot mode, and false to return to normal
        ///         decode mode after image capture. This only applies in Presentation Snapshot by Motion mode.
        ///     </para>
        ///     <para>Values: true(On) false(Off)</para>
        /// </summary>
        public bool ContinuousSnapshotEnabled
        {
            get { return (bool)GetAttribute((ushort)ImagingAttribute.ContinuousSnapshot).Value; }
            set
            {
                SetAttribute(new ScannerAttribute
                             {
                                 Id = (ushort)ImagingAttribute.ContinuousSnapshot,
        ...
        {
            get { return Convert.ToUInt16(GetAttribute((ushort)ImagingAttribute.ContrastEnhancement).Value) == 1; }
            set
            {
                var v = value ? "1" : "0";
                SetAttribute(new ScannerAttribute
                             {
                                 Id = (ushort)ImagingAttribute.ContrastEnhancement,
                                 DataType = DataType.Byte,
                                 Value = v
                             });
            }
        ...
        {
            get { return Convert.ToUInt16(GetAttribute((ushort)ImagingAttribute.CropBottom).Value); }
            set
            {
                SetAttribute(new ScannerAttribute
                             {
                                 Id = (ushort)ImagingAttribute.CropBottom,
        ...
        {
            get { return Convert.ToUInt16(GetAttribute((ushort)ImagingAttribute.CropLeft).Value); }
            set
            {
                SetAttribute(new ScannerAttribute
                             {
                                 Id = (ushort)ImagingAttribute.CropLeft,
                                 DataType = DataType.UShort,
                                 Value = value
                             });
            }
        ...
        {
            get { return Convert.ToUInt16(GetAttribute((ushort)ImagingAttribute.CropRight).Value); }
            set
            {
                SetAttribute(new ScannerAttribute
                             {
                                 Id = (ushort)ImagingAttribute.CropRight,
                                 DataType = DataType.UShort,
                                 Value = value
                             });
            }
        ...
        {
            get { return Convert.ToUInt16(GetAttribute((ushort)ImagingAttribute.CropTop).Value); }
            set
            {
                SetAttribute(new ScannerAttribute
                             {
                                 Id = (ushort)ImagingAttribute.CropTop,
                                 DataType = DataType.UShort,
                                 Value = value
                             });
            }
        ...
        {
            get { return Convert.ToUInt16(GetAttribute((ushort)ImagingAttribute.Exposure).Value); }
            set
            {
                SetAttribute(new ScannerAttribute
                             {
                                 Id = (ushort)ImagingAttribute.Exposure,
                                 DataType = DataType.UShort,
                                 Value = value
                             });
            }
        ...
        {
            get { return Convert.ToUInt16(GetAttribute((ushort)ImagingAttribute.IlluminationBrightness).Value); }
            set
            {
                SetAttribute(new ScannerAttribute
                             {
                                 Id = (ushort)ImagingAttribute.IlluminationBrightness,
                                 DataType = DataType.Byte,
                                 Value = value
                             });
            }
        ...
        {
            get { return Convert.ToUInt16(GetAttribute((ushort)ImagingAttribute.ImageEdgeSharpen).Value); }
            set
            {
                SetAttribute(new ScannerAttribute
                             {
        ...
        {
            get { return Convert.ToUInt16(GetAttribute((ushort)ImagingAttribute.VideoSubsample).Value); }
            set
            {
                SetAttribute(new ScannerAttribute
                             {
                                 Id = (ushort)ImagingAttribute.VideoSubsample,
                                 DataType = DataType.Byte,
                                 Value = value
                             });
            }
        ...
        {
            get { return (ImageRotation)GetAttribute((ushort)ImagingAttribute.ImageRotation).Value; }
            set
            {
                SetAttribute(new ScannerAttribute
                             {
                                 Id = (ushort)ImagingAttribute.ImageRotation,
                                 DataType = DataType.Byte,
                                 Value = (byte)value
                             });
            }
        ...
        {
            get { return Convert.ToUInt16(GetAttribute((ushort)ImagingAttribute.JPEGFileSizeWord).Value); }
            set
            {
                SetAttribute(new ScannerAttribute
                             {
                                 Id = (ushort)ImagingAttribute.JPEGFileSizeWord,
                                 DataType = DataType.UShort,
                                 Value = value
                             });
            }
        ...
        ///     <para>
        ///         When enabled, once an object in the field of view remains stationary, an
        ///         image will be taken and transmitted to the host. This applies to Snapshot mode only.
        ///     </para>
        ///     <para>Values: 5 to 5000</para>
        /// </summary>
        public bool SnapshotByMotionEnabled
        {
            get { return (bool)GetAttribute((ushort)ImagingAttribute.SnapshotByMotion).Value; }
            set
            {
                SetAttribute(new ScannerAttribute
                             {
                                 Id = (ushort)ImagingAttribute.SnapshotByMotion,
                                 DataType = DataType.Bool,
                                 Value = value
                             });
            }
