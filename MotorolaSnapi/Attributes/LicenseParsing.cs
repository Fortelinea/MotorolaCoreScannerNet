...
namespace Motorola.Snapi.Attributes
{
    ...
    public class LicenseParsing : MotorolaAttributeSet
    {
        ...
        /// <para>Description: This parameter specifies a Driver’s License parsing Mode. It can be disabled,
        ...
        /// <para>Description: The buffer containing the DL parse rules.</para>
        ...
        public byte[] LicenseParseBuffer
        {
            get
            {
                ...
                if (attribute != null)
                    return ValueConverters.HexStringToByteArray((string)GetAttribute(LicenseParsingAttribute.DLParseBuffer).Value);
                return null;
            }
            set
            {
