...
namespace Motorola.Snapi.Attributes
{
    ...
    public class Pdf : MotorolaAttributeSet
    {
        ...
        {
            get { return (bool)GetAttribute((ushort)PdfAttribute.MicroPdf).Value; }
            set
            {
                SetAttribute(new ScannerAttribute
                             {
                                 Id = (ushort)PdfAttribute.MicroPdf,
        ...
        {
            get { return (bool)GetAttribute((ushort)PdfAttribute.Pdf).Value; }
            set
            {
                SetAttribute(new ScannerAttribute
                             {
                                 Id = (ushort)PdfAttribute.Pdf,
                                 DataType = DataType.Bool,
                                 Value = value
                             });
            }
