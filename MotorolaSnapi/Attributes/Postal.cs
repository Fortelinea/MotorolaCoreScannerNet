...
namespace Motorola.Snapi.Attributes
{
    ...
    public class Postal : MotorolaAttributeSet
    {
        ...
        {
            get { return (bool)GetAttribute((ushort)PostalAttribute.AusPost).Value; }
            set
            {
                SetAttribute(new ScannerAttribute
                             {
                                 Id = (ushort)PostalAttribute.AusPost,
        ...
        {
            get { return (bool)GetAttribute((ushort)PostalAttribute.CanadaPost).Value; }
            set
            {
                SetAttribute(new ScannerAttribute
                             {
                                 Id = (ushort)PostalAttribute.CanadaPost,
                                 DataType = DataType.Bool,
                                 Value = value
                             });
            }
        ...
        {
            get { return (bool)GetAttribute((ushort)PostalAttribute.JapanPost).Value; }
            set
            {
                SetAttribute(new ScannerAttribute
                             {
                                 Id = (ushort)PostalAttribute.JapanPost,
                                 DataType = DataType.Bool,
                                 Value = value
                             });
            }
        ...
        {
            get { return (bool)GetAttribute((ushort)PostalAttribute.UkPost).Value; }
            set
            {
                SetAttribute(new ScannerAttribute
                             {
                                 Id = (ushort)PostalAttribute.UkPost,
                                 DataType = DataType.Bool,
                                 Value = value
                             });
            }
        ...
        {
            get { return (bool)GetAttribute((ushort)PostalAttribute.UkPostParity).Value; }
            set
            {
                SetAttribute(new ScannerAttribute
                             {
                                 Id = (ushort)PostalAttribute.UkPostParity,
                                 DataType = DataType.Bool,
                                 Value = value
                             });
            }
        ...
        {
            get { return (bool)GetAttribute((ushort)PostalAttribute.UsPost1).Value; }
            set
            {
                SetAttribute(new ScannerAttribute
                             {
                                 Id = (ushort)PostalAttribute.UsPost1,
                                 DataType = DataType.Bool,
                                 Value = value
                             });
            }
        ...
        {
            get { return (bool)GetAttribute((ushort)PostalAttribute.UsPost2).Value; }
            set
            {
                SetAttribute(new ScannerAttribute
                             {
                                 Id = (ushort)PostalAttribute.UsPost2,
                                 DataType = DataType.Bool,
                                 Value = value
                             });
            }
        ...
        {
            get { return (bool)GetAttribute((ushort)PostalAttribute.UsPostParity).Value; }
            set
            {
                SetAttribute(new ScannerAttribute
                             {
                                 Id = (ushort)PostalAttribute.UsPostParity,
                                 DataType = DataType.Bool,
                                 Value = value
                             });
            }
