...
namespace Motorola.Snapi.Attributes
{
    ...
    public class UpcEan : MotorolaAttributeSet
    {
        ...
        {
            get { return (bool)GetAttribute((ushort)UpcEanAttribute.BooklandEan).Value; }
            set
            {
                SetAttribute(new ScannerAttribute
                             {
                                 Id = (ushort)UpcEanAttribute.BooklandEan,
        ...
        ///     <para>
        ///         Enable this parameter to convert UPC-E1 decoded data to UPC-A format before transmission. After conversion,
        ///         the data follows UPC-A format and is affected by UPC-A programming selections (e.g., Preamble, Check Digit).
        ///     </para>
        /// </summary>
        public bool ConvertUpcE1toA
        {
            get { return (bool)GetAttribute((ushort)UpcEanAttribute.ConvertUpce1ToA).Value; }
            set
            {
                SetAttribute(new ScannerAttribute
                             {
                                 Id = (ushort)UpcEanAttribute.ConvertUpce1ToA,
                                 DataType = DataType.Bool,
                                 Value = value
                             });
            }
        ...
        ///     <para>
        ///         Enable this parameter to convert UPC-E (zero suppressed) decoded data to UPC-A format before transmission.
        ///         After conversion,
        ///         the data follows UPC-A format and is affected by UPC-A programming selections (e.g., Preamble, Check Digit).
        ///     </para>
        /// </summary>
        ...
        {
            get { return (bool)GetAttribute((ushort)UpcEanAttribute.ConvertUpcEtoA).Value; }
            set
            {
                SetAttribute(new ScannerAttribute
                             {
                                 Id = (ushort)UpcEanAttribute.ConvertUpcEtoA,
                                 DataType = DataType.Bool,
                                 Value = value
                             });
            }
        ...
        {
            get { return (bool)GetAttribute((ushort)UpcEanAttribute.Ean13Jan13).Value; }
            set
            {
                SetAttribute(new ScannerAttribute
                             {
                                 Id = (ushort)UpcEanAttribute.Ean13Jan13,
                                 DataType = DataType.Bool,
                                 Value = value
                             });
            }
        ...
        {
            get { return (bool)GetAttribute((ushort)UpcEanAttribute.Ean8Jan8).Value; }
            set
            {
                SetAttribute(new ScannerAttribute
                             {
                                 Id = (ushort)UpcEanAttribute.Ean8Jan8,
                                 DataType = DataType.Bool,
                                 Value = value
                             });
            }
        ...
        {
            get { return (bool)GetAttribute((ushort)UpcEanAttribute.Ean8Jan8Extend).Value; }
            set
            {
                SetAttribute(new ScannerAttribute
                             {
                                 Id = (ushort)UpcEanAttribute.Ean8Jan8Extend,
                                 DataType = DataType.Bool,
                                 Value = value
                             });
            }
        ...
        {
            get { return (bool)GetAttribute((ushort)UpcEanAttribute.Supp2).Value; }
            set
            {
                SetAttribute(new ScannerAttribute
                             {
                                 Id = (ushort)UpcEanAttribute.Supp2,
                                 DataType = DataType.Bool,
                                 Value = value
                             });
            }
        ...
        {
            get { return (bool)GetAttribute((ushort)UpcEanAttribute.Supp5).Value; }
            set
            {
                SetAttribute(new ScannerAttribute
                             {
                                 Id = (ushort)UpcEanAttribute.Supp5,
                                 DataType = DataType.Bool,
                                 Value = value
                             });
            }
        ...
        ///     <remarks>
        ///         <para>"None"(00), "AIM Code ID"(01), "Symbol Code ID"(02)</para>
        ///     </remarks>
        /// </summary>
        public TransmitCodeId TransmitCodeId
        {
            get { return (TransmitCodeId)GetAttribute((ushort)UpcEanAttribute.TransmitCodeId).Value; }
            set
            {
                SetAttribute(new ScannerAttribute
                             {
                                 Id = (ushort)UpcEanAttribute.TransmitCodeId,
        ...
        {
            get { return (bool)GetAttribute((ushort)UpcEanAttribute.TransmitUpcACheckDigit).Value; }
            set
            {
                SetAttribute(new ScannerAttribute
                             {
                                 Id = (ushort)UpcEanAttribute.TransmitUpcACheckDigit,
                                 DataType = DataType.Bool,
                                 Value = value
                             });
            }
        ...
        {
            get { return (bool)GetAttribute((ushort)UpcEanAttribute.TransmitUpcE1CheckDigit).Value; }
            set
            {
                SetAttribute(new ScannerAttribute
                             {
                                 Id = (ushort)UpcEanAttribute.TransmitUpcE1CheckDigit,
                                 DataType = DataType.Bool,
                                 Value = value
                             });
            }
        ...
        {
            get { return (bool)GetAttribute((ushort)UpcEanAttribute.TransmitUpcECheckDigit).Value; }
            set
            {
                SetAttribute(new ScannerAttribute
                             {
                                 Id = (ushort)UpcEanAttribute.TransmitUpcECheckDigit,
                                 DataType = DataType.Bool,
                                 Value = value
                             });
            }
        ...
        ///     <para>
        ///         When enabled, this parameter decodes UPCA bar codes starting with digit ‘5’, EAN-13 bar codes starting with
        ///         digit
        ///         ‘99’, and UPCA/EAN-128 Coupon Codes. UPCA, EAN-13 and EAN-128 must be enabled to scan all types of Coupon
        ///         Codes.
        ///     </para>
        /// </summary>
        public bool UccCouponExtendedCodeEnabled
        {
            get { return (bool)GetAttribute((ushort)UpcEanAttribute.UccCouponExtendedCode).Value; }
            set
            {
                SetAttribute(new ScannerAttribute
                             {
                                 Id = (ushort)UpcEanAttribute.UccCouponExtendedCode,
                                 DataType = DataType.Bool,
                                 Value = value
                             });
            }
        ...
        {
            get { return (bool)GetAttribute((ushort)UpcEanAttribute.UpcA).Value; }
            set
            {
                SetAttribute(new ScannerAttribute
                             {
                                 Id = (ushort)UpcEanAttribute.UpcA,
                                 DataType = DataType.Bool,
                                 Value = value
                             });
            }
        ...
        {
            get { return (UpcPreamble)GetAttribute((ushort)UpcEanAttribute.UpcAPreamble).Value; }
            set
            {
                SetAttribute(new ScannerAttribute
                             {
                                 Id = (ushort)UpcEanAttribute.UpcAPreamble,
                                 DataType = DataType.Byte,
                                 Value = (byte)value
                             });
            }
        ...
        {
            get { return (bool)GetAttribute((ushort)UpcEanAttribute.UpcE1).Value; }
            set
            {
                SetAttribute(new ScannerAttribute
                             {
                                 Id = (ushort)UpcEanAttribute.UpcE1,
                                 DataType = DataType.Bool,
                                 Value = value
                             });
            }
        ...
        {
            get { return (UpcPreamble)GetAttribute((ushort)UpcEanAttribute.UpcE1Preamble).Value; }
            set
            {
                SetAttribute(new ScannerAttribute
                             {
                                 Id = (ushort)UpcEanAttribute.UpcE1Preamble,
                                 DataType = DataType.Byte,
                                 Value = (byte)value
                             });
            }
        ...
        ///     <para>
        ///         Decode Supplemental (2 and 5 digits). Supplementals are bar codes appended according to
        ...
        {
            get { return (SupplementalMode)GetAttribute((ushort)UpcEanAttribute.UpcEanJanSupplementals).Value; }
            set
            {
                SetAttribute(new ScannerAttribute
                             {
        ...
        ///     <para>
        ///         With Auto discriminate UPC/EAN/JAN Supplemental selected, this parameter adjusts
        ///         the number of times a symbol without Supplemental is decoded before transmission. The range is from two to
        ///         thirty
        ...
        {
            get { return Convert.ToUInt16(GetAttribute((ushort)UpcEanAttribute.UpcEanJanSupplementalRedundancy).Value); }
            set
            {
                SetAttribute(new ScannerAttribute
                             {
                                 Id = (ushort)UpcEanAttribute.UpcEanJanSupplementalRedundancy,
                                 DataType = DataType.Byte,
                                 Value = value
                             });
            }
        ...
        {
            get { return (bool)GetAttribute((ushort)UpcEanAttribute.UpcE).Value; }
            set
            {
                SetAttribute(new ScannerAttribute
                             {
                                 Id = (ushort)UpcEanAttribute.UpcE,
                                 DataType = DataType.Bool,
                                 Value = value
                             });
            }
        ...
        {
            get { return (UpcPreamble)GetAttribute((ushort)UpcEanAttribute.UpcEPreamble).Value; }
            set
            {
                SetAttribute(new ScannerAttribute
                             {
                                 Id = (ushort)UpcEanAttribute.UpcEPreamble,
                                 DataType = DataType.Byte,
                                 Value = (byte)value
                             });
            }
