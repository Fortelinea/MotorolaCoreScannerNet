...
namespace Motorola.Snapi
{
    public partial class BarcodeScanner : IMotorolaBarcodeScanner
    {
        ...
        public MacroPdf MacroPDF
        {
            get { return _macroPdf ?? (_macroPdf = new MacroPdf(_scannerDriver, Info.ScannerId)); }
        }
        ...
        {
            get { return _actions ?? (_actions = new Actions(_scannerDriver, Info.ScannerId)); }
        }
        ...
        {
            get { return _defaults ?? (_defaults = new Defaults(_scannerDriver, Info.ScannerId)); }
        }
        ...
        {
            get { return _firmware ?? (_firmware = new Firmware(_scannerDriver, Info.ScannerId)); }
        }
        ...
        {
            get { return _accessControl ?? (_accessControl = new AccessControl(_scannerDriver, Info.ScannerId)); }
        }
        ...
        {
            get { return _trigger ?? (_trigger = new Trigger(_scannerDriver, Info.ScannerId)); }
        }
        ...
        {
            const string setCommandXml =
                @"<inArgs><scannerID>{0}</scannerID><cmdArgs><arg-string>{1}</arg-string><arg-bool>{2}</arg-bool><arg-bool>{3}</arg-bool></cmdArgs></inArgs>";
